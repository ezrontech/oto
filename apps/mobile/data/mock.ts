...
export const MOCK_NOTES = [
    {
        ...
        content: "Your post on 'AI Ops' is trending. Reply to LinkedIn comments!",
        type: "social"
    },
    {
        id: 2,
        title: "News: IG Ads",
        content: "New privacy updates for IG Ads arriving Q1. Audit assets?",
        type: "news"
    }
];
...
export const MOCK_CONVERSATIONS = [
    {
        ...
        messages: [
            { id: 1, role: "agent", content: "Owner will be with you shortly.", sender: "Agent", timestamp: "10:30" },
            { id: 2, role: "owner", content: "10 mins works.", sender: "Owner", timestamp: "10:35" },
            { id: 3, role: "user", content: "Perfect.", sender: "Alice", timestamp: "10:36" }
        ]
    }
];
